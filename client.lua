    ...
    while true do
        ...
        if inZone then
            ...
            if not hasRun and istInDimension then
             ...
             TriggerEvent('notify', '4', 'FFA', 'Du hast die Zone verlassen und wirst jetzt wieder an einen Spawnpunkt gesendet!')
                end
            end
        end
end)
...
function drawPoly(isEntityZone)
  ...
  AddEventHandler('loadout', function ()
      ...
      TriggerEvent('notify', '1', 'FFA', 'Du hast die FFA Zone betreten, mit dem Command /quitffa kannst du die Zone Verlassen')
  ...
  AddEventHandler('removeloadout', function ()
    ...
    TriggerEvent('weapontrigger3')
      ...
      TriggerEvent('notify', '3', 'FFA', 'Du hast die FFA Zone verlassen')
